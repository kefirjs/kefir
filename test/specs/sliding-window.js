...
describe('slidingWindow', function() {
  ...
  describe('stream', function() {
    ...
    it('should be ended if source was ended', () => expect(send(stream(), ['<end>']).slidingWindow(1)).toEmit(['<end:current>']));
    ...
    it('.slidingWindow(3, 2) should work correctly', function() {
      const a = stream();
      return expect(a.slidingWindow(3, 2)).toEmit([
        [1, 2],
        [1, 2, 3],
        [2, 3, 4],
        [3, 4, 5],
    ...
    it('.slidingWindow(3, 3) should work correctly', function() {
      const a = stream();
      return expect(a.slidingWindow(3, 3)).toEmit([
        [1, 2, 3],
        [2, 3, 4],
        [3, 4, 5],
        '<end>'
  ...
  return describe('property', function() {
    ...
    it('should be ended if source was ended', () => expect(send(prop(), ['<end>']).slidingWindow(1)).toEmit(['<end:current>']));
