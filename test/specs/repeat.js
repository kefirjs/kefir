...
describe('repeat', function() {
  ...
  it('should work correctly (with .constant)', function() {
    ...
    return expect(a.take(3)).toEmit([{current: 0}, {current: 1}, {currentError: 2}, {current: 3}, '<end:current>'])
  })
  ...
  return it('should end when falsy value returned from generator', function() {
    ...
    return expect(a).toEmit([{current: 0}, {current: 1}, {current: 2}, '<end:current>'])
  })
})
