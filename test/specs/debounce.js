...
describe('debounce', function() {
  ...
  describe('stream', function() {
    ...
    it('should be ended if source was ended', () => expect(send(stream(), ['<end>']).debounce(100)).toEmit(['<end:current>']));
  ...
  return describe('property', function() {
    ...
    it('should be ended if source was ended', () => expect(send(prop(), ['<end>']).debounce(100)).toEmit(['<end:current>']));

    it('should be ended if source was ended (with current)', () => expect(send(prop(), [1, '<end>']).debounce(100)).toEmit([{current: 1}, '<end:current>']));
