 ...
 */
const {stream, send, activate, Kefir} = require('../test-helpers.coffee');
...
describe('Stream', function() {
  ...
  return describe('subscribers', function() {
    ...
    it('onValue subscribers should be called with 1 argument', function() {
      const s = stream();
      let count = null;
      s.onValue(function() { return count = arguments.length; });
      send(s, [1]);
    ...
    it('onError subscribers should be called with 1 argument', function() {
      const s = stream();
      let count = null;
      s.onError(function() { return count = arguments.length; });
      send(s, [{error: 1}]);
      return expect(count).toBe(1);
    });
    ...
    it('onAny subscribers should be called with 1 arguments', function() {
      const s = stream();
      let count = null;
      s.onAny(function() { return count = arguments.length; });
      send(s, [1]);
      return expect(count).toBe(1);
    });
    ...
    it('onEnd subscribers should be called with 0 arguments', function() {
      const s = stream();
      let count = null;
      s.onEnd(function() { return count = arguments.length; });
      send(s, ['<end>']);
      expect(count).toBe(0);
      s.onEnd(function() { return count = arguments.length; });
