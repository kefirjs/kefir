...
describe('skipUntilBy', function() {
  ...
  describe('stream, stream', function() {
    ...
    it('should be ended if primary was ended', () => expect(send(stream(), ['<end>']).skipUntilBy(stream())).toEmit(['<end:current>']));

    it('should be ended if secondary was ended', () => expect(stream().skipUntilBy(send(stream(), ['<end>']))).toEmit(['<end:current>']));
  ...
  describe('stream, property', function() {
    ...
    it('should be ended if primary was ended', () => expect(send(stream(), ['<end>']).skipUntilBy(prop())).toEmit(['<end:current>']));

    it('should be ended if secondary was ended and has no current', () => expect(stream().skipUntilBy(send(prop(), ['<end>']))).toEmit(['<end:current>']));

    it('should not be ended if secondary was ended but has any current', () => expect(stream().skipUntilBy(send(prop(), [0, '<end>']))).toEmit([]));
  ...
  describe('property, stream', function() {
    ...
    it('should be ended if primary was ended', () => expect(send(prop(), ['<end>']).skipUntilBy(stream())).toEmit(['<end:current>']));

    it('should be ended if secondary was ended', () => expect(prop().skipUntilBy(send(stream(), ['<end>']))).toEmit(['<end:current>']));
  ...
  return describe('property, property', function() {
    ...
    it('should be ended if primary was ended', () => expect(send(prop(), ['<end>']).skipUntilBy(prop())).toEmit(['<end:current>']));

    it('should be ended if secondary was ended and has no current', () => expect(prop().skipUntilBy(send(prop(), ['<end>']))).toEmit(['<end:current>']));

    it('should not be ended if secondary was ended but has any current', () => expect(prop().skipUntilBy(send(prop(), [0, '<end>']))).toEmit([]));
