...
describe('takeWhile', function() {
  ...
  describe('stream', function() {
    ...
    it('should be ended if source was ended', () => expect(send(stream(), ['<end>']).takeWhile(() => true)).toEmit(['<end:current>']));
  ...
  return describe('property', function() {
    ...
    it('should be ended if source was ended', () => expect(send(prop(), ['<end>']).takeWhile(() => true)).toEmit(['<end:current>']));

    it('should be ended if calback was `-> false` and source has a current', () => expect(send(prop(), [1]).takeWhile(() => false)).toEmit(['<end:current>']));
